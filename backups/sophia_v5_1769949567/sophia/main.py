...
class SophiaMind:
    ...
    async def perform_maintenance(self, user_instruction=None):
        ...
        USER INSTRUCTION: {user_instruction if user_instruction else "Optimize system state."}
        ERROR LOG: {error_block}
        TASK: Analyze, fix errors, and fulfill instructions.
        CONSTRAINT: Edit files to fulfill instructions or fix clear errors. Prefer analysis for vague issues.
        """
