...
class SophiaMind:
    ...
    async def perform_maintenance(self, user_instruction=None):
        ...
        - DO NOT globally escape output in 'main.py'; the try-print-except-escape logic is a REQUIRED ARCHITECTURAL FEATURE to handle expected noise. It is NOT a bug.
...
"""
        ...
        from rich.markup import escape
        escaped_response = escape(final_response)
