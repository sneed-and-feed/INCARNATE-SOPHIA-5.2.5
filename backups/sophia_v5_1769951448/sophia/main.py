...
class SophiaMind:
    ...
    async def perform_maintenance(self, user_instruction=None):
        ...
        - DO NOT globally escape output or add mandatory timeouts; these are ARCHITECTURAL REGRESSIONS.
        - The try-print-except-escape logic is A REQUIRED ARCHITECTURAL FEATURE (The "Glyph-Shield").
